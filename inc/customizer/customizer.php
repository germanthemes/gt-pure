...
function gt_drive_customize_preview_js() {
	wp_enqueue_script( 'gt-drive-customize-preview', get_template_directory_uri() . '/assets/js/customize-preview.min.js', array( 'customize-preview' ), '20191125', true );
...
function gt_drive_customizer_controls_js() {
	wp_enqueue_script( 'gt-drive-customizer-controls', get_template_directory_uri() . '/assets/js/customizer-controls.min.js', array(), '20190722', true );
}
...
function gt_drive_customizer_controls_css() {
	wp_enqueue_style( 'gt-drive-customizer-controls', get_template_directory_uri() . '/assets/css/customizer-controls.css', array(), '20191125' );
}
